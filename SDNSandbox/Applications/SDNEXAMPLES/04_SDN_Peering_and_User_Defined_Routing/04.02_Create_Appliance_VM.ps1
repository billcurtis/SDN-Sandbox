...
Invoke-Command -ComputerName SDNHOST1 -Credential $domainCred -ScriptBlock {
    ...
    $ImagePath = "\\SDNHOST1\c$\ClusterStorage\S2D_vDISK1\$VMName\GUI.vhdx"
...
New-VM -Name Appliance -ComputerName SDNHOST1 -VHDPath C:\ClusterStorage\S2D_vDISK1\Appliance\GUI.vhdx `
